...
(
    ...
    user_id         BIGINT,
    subscribed      BOOLEAN,
    CONSTRAINT pk_subs_id PRIMARY KEY (subscription_id),
    CONSTRAINT fk_subs_user_id FOREIGN KEY (user_id) REFERENCES users (user_id) ON DELETE CASCADE,
    CONSTRAINT fk_subs_subscriber_id FOREIGN KEY (subscriber_id) REFERENCES users (user_id) ON DELETE CASCADE
);